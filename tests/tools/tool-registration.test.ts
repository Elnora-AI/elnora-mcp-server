...
describe("Tool Registration", () => {
  ...
  it("has scope definitions for all tool groups", () => {
    const toolGroups = {
      tasks: ["elnora_tasks_list", "elnora_tasks_get", "elnora_tasks_messages", "elnora_tasks_create", "elnora_tasks_send", "elnora_tasks_update", "elnora_tasks_archive", "elnora_tasks_unarchive", "elnora_tasks_attachments", "elnora_tasks_attachmentContent"],
      files: ["elnora_files_list", "elnora_files_get", "elnora_files_content", "elnora_files_versions", "elnora_files_versionContent", "elnora_files_upload", "elnora_files_create", "elnora_files_update", "elnora_files_archive", "elnora_files_download", "elnora_files_createVersion", "elnora_files_restore", "elnora_files_promote", "elnora_files_fork", "elnora_files_workingCopy", "elnora_files_commit", "elnora_files_uploadBatch", "elnora_files_confirmUpload", "elnora_files_searchContent", "elnora_files_move", "elnora_files_share", "elnora_files_unshare", "elnora_files_shares"],
      ...
      orgs: ["elnora_orgs_list", "elnora_orgs_get", "elnora_orgs_create", "elnora_orgs_update", "elnora_orgs_delete", "elnora_orgs_members", "elnora_orgs_updateRole", "elnora_orgs_removeMember", "elnora_orgs_billing", "elnora_orgs_setStripe", "elnora_orgs_setDefault", "elnora_orgs_invite", "elnora_orgs_invitations", "elnora_orgs_cancelInvite", "elnora_orgs_resendInvite", "elnora_orgs_invitationInfo", "elnora_orgs_acceptInvite", "elnora_orgs_files", "elnora_orgs_listAll", "elnora_orgs_directory", "elnora_orgs_setAutotidy"],
      review: ["elnora_review_list", "elnora_review_approve", "elnora_review_reject"],
      folders: ["elnora_folders_roots", "elnora_folders_children", "elnora_folders_get", "elnora_folders_files", "elnora_folders_list", "elnora_folders_create", "elnora_folders_rename", "elnora_folders_move", "elnora_folders_delete", "elnora_folders_share", "elnora_folders_unshare", "elnora_folders_shares"],
